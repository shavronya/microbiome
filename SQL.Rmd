...
```{r}
packages <- c("RMySQL", "tidyverse", "rvest", "magrittr", "ggmap", "stringr", "RColorBrewer", "dplyr", "ggplot2", "plotly", "ggrepel", "flextable", "maps")
...
```{r}
result1 <- dbSendQuery(mysqlconnection, "select site_type, host_id from site join host on site.site_id = host.site_id") 
